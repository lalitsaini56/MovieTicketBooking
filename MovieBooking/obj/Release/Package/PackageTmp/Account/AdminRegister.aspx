                    ...
                    <div class="col-lg-8">
                        <div class="p-5">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 ">
                                    <asp:TextBox class="form-control form-control-user" runat="server" ID="txtFirstName" placeholder="First Name"></asp:TextBox>

                                </div>

                                <div class="col-sm-4 ">
                                    <asp:TextBox class="form-control form-control-user" runat="server" ID="txtMiddleName" placeholder="Middle Name"></asp:TextBox>
                                </div>

                                <div class="col-sm-4">
                                    <asp:TextBox class="form-control form-control-user" runat="server" ID="txtLastName" placeholder="Last Name"></asp:TextBox>

                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 ">
                                    <asp:TextBox class="form-control form-control-user" runat="server" ID="txtMobileNo" placeholder="Mobile No" MaxLength="10"></asp:TextBox>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 ">
                                    <asp:TextBox class="form-control form-control-user" runat="server" ID="txtOTP" placeholder="OTP" MaxLength="6" Enabled="false"></asp:TextBox>
                                </div>

                            </div>

                            <asp:LinkButton ID="btnGetOTP" runat="server" class="btn btn-primary btn-user btn-block" Text="Get OTP" OnClick="btnGetOTP_Click" OnClientClick="return Validate();">
                            </asp:LinkButton>
